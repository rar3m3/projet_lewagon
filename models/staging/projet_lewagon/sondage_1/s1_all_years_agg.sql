...
SELECT
    *
    , CASE
        ------2002
        WHEN (candidat LIKE "%laguiller%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%gluckstein%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%besancenot%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%hue%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%jospin%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%taubira%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%mamere%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%chevenement%" AND annee = "2002-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%lepage%" AND annee = "2002-01-01") THEN "Centre"
        ...
        ------2007
        WHEN (candidat LIKE "%laguiller%" AND annee = "2007-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%besancenot%" AND annee = "2007-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%buffet%" AND annee = "2007-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%schivardi%" AND annee = "2007-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%royal%" AND annee = "2007-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%bove%" AND annee = "2007-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%voynet%" AND annee = "2007-01-01") THEN "Gauche"
        ...
        -------2012
        WHEN (candidat LIKE "%arthaud%" AND annee = "2012-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%poutou%" AND annee = "2012-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%melenchon%" AND annee = "2012-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%hollande%" AND annee = "2012-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%joly%" AND annee = "2012-01-01") THEN "Gauche"
        ...
        -------2017
        WHEN (candidat LIKE "%arthaud%" AND annee = "2017-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%poutou%" AND annee = "2017-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%melenchon%" AND annee = "2017-01-01") THEN "Gauche"
        ...
        -------2022
        WHEN (candidat LIKE "%arthaud%" AND annee = "2022-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%poutou%" AND annee = "2022-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%roussel%" AND annee = "2022-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%melenchon%" AND annee = "2022-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%hidalgo%" AND annee = "2022-01-01") THEN "Gauche"
        WHEN (candidat LIKE "%jadot%" AND annee = "2022-01-01") THEN "Gauche"
    ...
    , CASE
        ...
        WHEN (candidat LIKE "%mamere%" AND annee = "2002-01-01") THEN "LV"
        ...
        WHEN (candidat LIKE "%le_pen%" AND annee = "2002-01-01") THEN "FN"
        ...
        WHEN (candidat LIKE "%voynet%" AND annee = "2007-01-01") THEN "LV"
        ...
        WHEN (candidat LIKE "%le_pen%" AND annee = "2007-01-01") THEN "FN"
        -------2012
        ...
        WHEN (candidat LIKE "%joly%" AND annee = "2012-01-01") THEN "EELV"
        ...
        WHEN (candidat LIKE "%le_pen%" AND annee = "2012-01-01") THEN "FN"
        ...
        WHEN (candidat LIKE "%macron%" AND annee = "2017-01-01") THEN "EM"
        ...
        WHEN (candidat LIKE "%le_pen%" AND annee = "2017-01-01") THEN "FN"
        ...
        WHEN (candidat LIKE "%jadot%" AND annee = "2022-01-01") THEN "EELV"
        WHEN (candidat LIKE "%macron%" AND annee = "2022-01-01") THEN "LREM"
        ...
        WHEN (candidat LIKE "%le_pen%" AND annee = "2022-01-01") THEN "RN"
