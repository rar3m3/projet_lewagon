...
select
    ...
    SAFE_CAST(REPLACE(
        ...
        END, ',', '.') AS FLOAT64) AS nicolas_sarkozy_ump_float,
    ...
    SAFE_CAST(REPLACE(
        ...
        END, ',', '.') AS FLOAT64) AS philippe_de_villiers_mpf_float,
    ...
    SAFE_CAST(REPLACE(
        ...
        END, ',', '.') AS FLOAT64) AS frederic_nihous_cpnt_float,
