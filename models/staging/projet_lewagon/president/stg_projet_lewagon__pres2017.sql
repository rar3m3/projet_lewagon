...
renamed as (
    ...
    select
        ...
        COALESCE(SAFE_CAST(pvoixhamon AS FLOAT64), 0) AS pvoixhamon,
        ...
        COALESCE(SAFE_CAST(pvoixfillon AS FLOAT64), 0) AS pvoixfillon,
        COALESCE(SAFE_CAST(pvoixasselineau AS FLOAT64), 0) AS pvoixasselineau,
        ...
        COALESCE(SAFE_CAST(pvoixhamonratio AS FLOAT64), 0) AS pvoixhamonratio,
        ...
        COALESCE(SAFE_CAST(pvoixfillonratio AS FLOAT64), 0) AS pvoixfillonratio,
        COALESCE(SAFE_CAST(pvoixasselineauratio AS FLOAT64), 0) AS pvoixasselineauratio,
