...
SELECT 
    *
    , CASE 
        ...
        -------2017
        WHEN (candidat LIKE "%marcon%" AND annee = "2017-01-01") THEN "Centre"
    ...
    , CASE 
        ...
        WHEN (candidat LIKE "%sarkozy%" AND annee = "2012-01-01") THEN "FN"
        -------2017
        WHEN (candidat LIKE "%marcon%" AND annee = "2017-01-01") THEN "EM"
        WHEN (candidat LIKE "%_pen%" AND annee = "2017-01-01") THEN "FN"
        -------2022
        WHEN (candidat LIKE "%macron%" AND annee = "2022-01-01") THEN "LREM"
        WHEN (candidat LIKE "%_pen%" AND annee = "2022-01-01") THEN "RN"
    END AS parti
From agg_table
