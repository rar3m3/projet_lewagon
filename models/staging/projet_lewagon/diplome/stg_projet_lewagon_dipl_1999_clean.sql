...
SELECT
    ...
    diplome_de_niveau_cap_bephommes25_ans_ou_plusrp1999) AS niveau_CAP_BEP,
    (diplome_de_niveau_bac_general_ou_techniquehommes16_a_24_ansrp1999 +
    diplome_de_niveau_bac_general_ou_techniquehommes25_ans_ou_plusrp1999) AS bac_general_ou_technique,
...
SELECT 
    ...
    aucun_diplomefemmes25_ans_ou_plusrp1999) AS aucun_diplome,
    ...
    diplome_de_niveau_cap_bepfemmes25_ans_ou_plusrp1999) AS niveau_CAP_BEP,
    (diplome_de_niveau_bac_general_ou_techniquefemmes16_a_24_ansrp1999 +
    diplome_de_niveau_bac_general_ou_techniquefemmes25_ans_ou_plusrp1999) AS bac_general_ou_technique,
    ...
    diplome_universitaire_de_2eme_ou_3eme_cycle_femmes25_ans_ou_plusrp1999) AS niveau_universitaire
FROM {{ ref('stg_projet_lewagon__dpl_1999') }} --must be dbt built
WHERE region <> "RR23"