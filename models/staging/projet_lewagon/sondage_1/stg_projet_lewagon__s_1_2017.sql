...
select
    ...
    SAFE_CAST(REPLACE(
        ...
        END, ',', '.') AS FLOAT64) AS nicolas_dupont_aignan_dlf,
    ...
    SAFE_CAST(REPLACE(
        ...
        END, ',', '.') AS FLOAT64) AS francois_asselineau_upr,
