...
SELECT 
    ...
    diplome_de_niveau_cap_bephommes25_ans_ou_plusrp2010 +
    diplome_de_niveau_bac_general_ou_techniquehommes16_a_24_ansrp2010 +
    diplome_de_niveau_bac_general_ou_techniquehommes25_ans_ou_plusrp2010) AS equivalant_au_baccalaureat,
...
SELECT 
    ...
    aucun_diplomefemmes25_ans_ou_plusrp2010) AS `aucun diplome`,
    ...
    diplome_de_niveau_cap_bepfemmes25_ans_ou_plusrp2010 +
    diplome_de_niveau_bac_general_ou_techniquefemmes16_a_24_ansrp2010 +
    diplome_de_niveau_bac_general_ou_techniquefemmes25_ans_ou_plusrp2010) AS equivalant_au_baccalaureat,
